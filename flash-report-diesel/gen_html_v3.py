...
# A coluna tem ~520px de largura e sobram ~470px de altura abaixo do texto: quase um
# quadrado. Com cover a foto 16:9 perderia um terco da largura - na foto de grupo isso
# corta as duas pessoas das pontas; com um teto de altura ninguem e cortado, mas volta o
# buraco branco embaixo. Entao contain sobre fundo escuro: a moldura ocupa o card inteiro
# e a foto aparece completa dentro dela. O fundo e escuro porque a visita e noturna.
_UMA_FOTO = len(FOTOS_NOTURNO_ARQUIVOS) == 1
FOTO_NO_CARD = (
    f'<div style="flex:1;min-height:150px;margin-top:7px;border-radius:10px;'
    f'overflow:hidden;border:1px solid #CFE4DF;background:#132A27;">'
...
pages.append(f"""<div class="page-break"></div><div class="page">
  ...
  <div class="grid-2" style="align-items:start;">
    ...
    <div>{_crono_right}
      ...
      <div class="cons-text">Programação semanal de comunicação e engajamento com os motoristas. Setembro teve três séries. A primeira, nas duas primeiras semanas, foi sobre KM/L e Telemetria — como o sistema apura, no dia e no mês, o indicador que este relatório acompanha: "Por trás dos processos", "Como o Sistema sabe meu KM/L?", "Como o Sistema sabe minhas viagens?" e "Como meu KM/L é calculado no dia e no mês?", além do fechamento e da divulgação da data da Premiação Telemetria de agosto/2026. A partir da 3ª semana o tema passou a ser Segurança no Embarque e Desembarque de Passageiros, com o ciclo completo — imagem motivacional, Min. do Conhecimento, imagem informativa, podcast "Fala, Motô!" e enquete de fixação — de 14 a 18/09. Na 4ª semana o tema foi Direção Preventiva ("O semáforo fechou? Não precisa correr"), com Min. do Conhecimento e imagem informativa em 22 e 23/09 e o podcast "Fala, Motô!" com o Joel, da Manutenção. Das {len(CRONOGRAMA)} semanas de {MESREF_NOME.lower()}, {_n_feitos} dos {_n_itens} conteúdos já foram executados. {_crono_pend}</div></div>
    </div>
  </div>
  {footer(18)}
</div>""")
