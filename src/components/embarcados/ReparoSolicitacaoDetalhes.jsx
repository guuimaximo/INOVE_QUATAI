        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              <span className={`px-4 py-2 rounded-full text-xs font-black uppercase ${prioridadeClass(row.prioridade)}`}>
                {prioridadeLabel(row.prioridade)}
              </span>
              <span className={`px-4 py-2 rounded-full text-xs font-black uppercase ${statusClass(row.status)}`}>
