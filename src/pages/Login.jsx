...
import logoInova from "../assets/logoInovaQua.png";
...
export default function Login() {
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      ctxLogin({ id: profile.id, usuario_id: profile.usuario_id, nome: profile.nome, nivel: profile.nivel, setor: profile.setor, ativo: profile.ativo, login: profile.login, email: data.user.email });
      navigate("/home");
    } catch {
            ...
            <>
              ...
              <form onSubmit={handleVerificarLogin} className="space-y-4">
                <div>
                  ...
                  <input type="text" value={loginInput} onChange={e => setLoginInput(e.target.value)} placeholder="Seu login" autoFocus className="w-full bg-white/10 border border-white/20 rounded-lg px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 transition" />
                </div>
