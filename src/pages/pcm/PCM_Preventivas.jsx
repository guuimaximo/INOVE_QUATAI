...
export default function PCM_Preventivas() {
  ...
  const getStatusPreventiva = (item) => {
    const temMecanico = !!item?.mecanico;
    const temEletricista = !!item?.eletricista;
    const temFunilaria = !!item?.funilaria;
    const temBorracharia = !!item?.borracharia;

    if (item?.tipo === "Inspeção - 5.000") {
      return temMecanico && temEletricista ? "COMPLETO" : "INCOMPLETO";
    }

    if (item?.tipo === "Preventiva - 10.000") {
      return temMecanico && temEletricista && temFunilaria && temBorracharia
        ? "COMPLETO"
        : "INCOMPLETO";
    }
  ...
  const listaFiltrada = useMemo(() => {
    return (listaPreventivas || []).filter((item) => {
  ...
  return (
    <div className="w-full max-w-[98vw] 2xl:max-w-[1800px] mx-auto p-4 md:p-6 space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
        ...
        <div className="px-4 md:px-5 pb-4 flex flex-wrap gap-3">
          <button
            onClick={() =>
              setFiltros({
                data: "",
                  ...
                  <td colSpan="10" className="px-6 py-16">
                    <div className="flex flex-col items-center justify-center text-slate-400">
                      ...
                      <p className="text-sm mt-1">
                        Ajuste os filtros ou cadastre novas preventivas.
                      </p>
                    </div>
                  </td>
                </tr>
              ...
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    >
                      <option value="Preventiva - 10.000">
                        Preventiva - 10.000
                      </option>
