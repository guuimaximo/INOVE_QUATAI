...
import {
  FaCheckCircle, FaExclamationTriangle, FaPlus, FaCalendarCheck,
  FaChevronDown, FaChevronRight, FaShieldAlt, FaTools, FaSearch,
} from "react-icons/fa";
import { isoMaisDias } from "./preventivasLogic";
import {
  Cartao, Medidor, Kpi, Legenda, fmtInt, pctDe, fmtPct, semQuebra,
  COR_BOA, COR_RUIM, COR_NEUTRA,
} from "./resumoUI";
...
// feita = verde, ficou para trás = vermelho, a fazer = trilho neutro.
const COR_FEITA = COR_BOA;
const COR_ATRASADA = COR_RUIM;
const COR_AFAZER = COR_NEUTRA;
